...
def nwa(data_1, data_2, s=-3, m=1, d=-2):
    ...
    # data_1 = dict(list(sequence_data.items())[:len(sequence_data)//2])
    # data_2 = dict(list(sequence_data.items())[len(sequence_data)//2:])
