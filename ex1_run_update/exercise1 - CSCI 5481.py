...
# configuration input to adjust: chr3.fa hg19_annotation.txt chr7 0 61000000
...
def exercise1(args):
    ...
    print('*********************************************')
    print('Calcurate the proportions of each nucleotides')
    print('*********************************************')
    ...
    #p = math.ceil(len(genome)/10;
    #p = math.ceil(len(genome)/1000;
